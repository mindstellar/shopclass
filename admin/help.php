...
<div class="help-box">2. Themes directory ( oc-content/themes ) must have more safer permission 755 for Osclass Editor to work.</div>
<div class="help-box">3. You have enabled Permalinks.</div>
<div class="help-box">4. Settings Configured Correctly.</div>
<div class="help-box">5. Install free <a title="Free Rating Plugin" href="https://market.osclass.org/plugins/reviews-ratings/rating_35">Rating(Old Name:Voting) plugin</a> from Osclass Market. It will enable voting related features in our theme.</div>

<div style="margin-top:1em;margin-bottom:1em;"></div>

<h3 class="render-title">Documentation</h3>

<p>Visit <a href="https://www.tuffindia.com/docs/shopclass-osclass-docs/">TuffIndia.COM</a> For Shopclass Documentation</p>
