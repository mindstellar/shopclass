                ...
                <div class="form-horizontal">
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="text" class="xlarge" name="sitemap_number"
                                   value="<?php echo osc_esc_html( osc_get_preference( 'sitemap_number' , 'shopclass_theme' ) ); ?>">
                            <div class="help-box">Please enter number of URLs you want to show in each xml sitemap</div>
                            <div class="help-box">If you have more listing than above limit, it will create new sitemap
                                for those listings.
                            </div>
                            <div class="help-box" style="color:#ff0000">Keep it low if you are getting memory errors or
                                timeout errors.
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="checkbox" name="sitemap_categories"
                                   value="1"<?php echo( osc_get_preference( 'sitemap_categories' , 'shopclass_theme' ) ? 'checked' : '' ); ?>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="checkbox" name="sitemap_countries"
                                   value="1"<?php echo( osc_get_preference( 'sitemap_countries' , 'shopclass_theme' ) ? 'checked' : '' ); ?>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="checkbox" name="sitemap_regions"
                                   value="1"<?php echo( osc_get_preference( 'sitemap_regions' , 'shopclass_theme' ) ? 'checked' : '' ); ?>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="checkbox" name="sitemap_cities"
                                   value="1"<?php echo( osc_get_preference( 'sitemap_cities' , 'shopclass_theme' ) ? 'checked' : '' ); ?>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="checkbox" name="sitemap_cat_regions"
                                   value="1"<?php echo( osc_get_preference( 'sitemap_cat_regions' , 'shopclass_theme' ) ? 'checked' : '' ); ?>>
                            <div class="help-box">Please Check if you want to include Categories with Regions in
                                Sitemap
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <input type="checkbox" name="sitemap_cat_city"
                                   value="1"<?php echo( osc_get_preference( 'sitemap_cat_city' , 'shopclass_theme' ) ? 'checked' : '' ); ?>>
                            <div class="help-box">Please Check if you want to include Categories with Cities in
                                Sitemap
                            </div>
                        </div>
                    </div>
            ...
            <fieldset>
                <div class="form-horizontal">
                    <div class="form-row input-description-wide">
                        ...
                        <div class="form-controls"><textarea name="edit_robot"
                                                             rows="10"><?php echo $robot; ?></textarea></div>
                        <div class="help-box" style="color:#ff0000;">Make a backup before making any changes to your
                            Robots.txt file
                        </div>
                    </div>
...
<div class="well">
    <strong style="color:#ff0000;">Notice: Our sitemap functions generate dynamic and always updated sitemap and it
        doesn't need actual sitemap files in root directory. This will not work if you have any file named
        'sitemap.xml', 'sitemapindex.xml' or 'sitemap-index.xml' in root directory. Please remove those files before
        contacting support.</strong>
</div>