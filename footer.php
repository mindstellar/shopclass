...
<div class="col-md-12 end-box ">
        ...
        <?php if (osc_count_web_enabled_locales() > 1) { ?>
            | <span class="dropup">
            <span class="dropdown-toggle btn-sm" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span><i class="fa fa-keyboard-o"></i><?php echo osc_current_user_locale() ?><i class="fa fa-caret-up"></i></span>
            </span>
            <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenu2">
                ...
                <?php while (osc_has_web_enabled_locales()) { ?>
                    <li class="<?php if ($i == 0) {
                        echo "first";
                    } ?> <?php echo osc_locale_code() == osc_current_user_locale() ? 'disabled' : ''; ?>"><a id="<?php echo osc_locale_code(); ?>"
