            ...
            <div class="col-md-6">	
				<div id="signupbox">
						<form class="form-horizontal" name="register" id="register" action="<?php echo osc_base_url(true) ; ?>" method="post">
				            ...
				            <p class="lead form-group"><?php _e('Register now for','shopclass'); ?> <span class="text-success"><?php _e('FREE','shopclass'); ?></span></p>		
							<ul id="error_list"></ul>
							<div class="form-group">
								<label for="s_name" class="control-label"><?php _e('Your Name', 'shopclass') ; ?></label>
								
									<input class="form-control" id="s_name" type="text" name="s_name" value="" placeholder="<?php echo osc_esc_html(__('Enter your name', 'shopclass')) ; ?>">
								
							</div>
							<div class="form-group">
								<label for="s_username" class="control-label"><?php _e('Username', 'shopclass') ; ?></label>
								
									<input class="form-control" id="s_username" type="text" value="" name="s_username" placeholder="<?php echo osc_esc_html(__('Enter you username', 'shopclass')) ; ?>">
							...
							<div class="form-group">
								<label for="s_password" class="control-label"><?php _e('Password', 'shopclass') ; ?></label>
									...
									<input class="form-control" id="s_password" type="password" name="s_password" placeholder="<?php echo osc_esc_html(__('Enter your password', 'shopclass')) ; ?>">
								
							</div>
							<div class="form-group">
								<label for="s_password2" class="control-label"><?php _e('Re-type password', 'shopclass') ; ?></label>
								
									<input class="form-control" id="s_password2" type="password" name="s_password2" placeholder="<?php echo osc_esc_html(__('Re Enter your Password', 'shopclass')) ; ?>" >
								
							</div>
							<div class="form-group">
								<label for="s_email" class="control-label"><?php _e('E-mail', 'shopclass') ; ?></label>
								
									<input class="form-control" id="s_email" type="text" name="s_email" placeholder="<?php echo osc_esc_html(__('Enter you email address', 'shopclass')) ; ?>" >
							...
							<div class="form-group">
									...
									<button class="btn btn-block btn-primary" type="submit"><?php _e('Create Account', 'shopclass') ; ?></button>
									<?php if (function_exists('fbc_login_url')) { ?>
									<div class="btn-block text-center h3"><?php _e('Or', 'shopclass') ; ?></div>
									<a href="<?php echo fbc_login_url();?>" class="btn btn-block btn-facebook"><i class="fa fa-facebook"></i> <?php _e('Sign Up with Facebook', 'shopclass') ; ?></a> 
									<?php }
                  ...
                  <div class="col-md-6">
                      ...
                      <ul class="list-unstyled" style="line-height: 2">
                          <li><span class="fa fa-check text-success"></span> <?php _e('See all your listings','shopclass'); ?></li>
                          <li><span class="fa fa-check text-success"></span> <?php _e('Upload your avatar/logo','shopclass'); ?></li>
                          <li><span class="fa fa-check text-success"></span> <?php _e('Move listing to top','shopclass'); ?></li>
                          <li><span class="fa fa-check text-success"></span> <?php _e('Save your favorites','shopclass'); ?></li>
                          <li><span class="fa fa-check text-success"></span> <?php _e('Fast submission','shopclass'); ?></li>
                          <li><span class="fa fa-check text-success"></span> <?php _e('Edit your listings','shopclass'); ?></li>
                          
                      </ul>
                      <div class="btn-block text-center h3"><?php _e('Already Registered ?', 'shopclass') ; ?></div>
                      <p><a href="<?php echo osc_user_login_url() ; ?>" class="btn btn-info btn-block"><?php _e('Login now!','shopclass'); ?></a></p>
                  </div>
        </div>			
	</div>
