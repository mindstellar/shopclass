                            ...
                            <select name="sort-by" onchange="location = this.options[this.selectedIndex].value;"
                                ...
                                <?php $i = 0;
                                    ...
                                    if ( Params::getParam ( 'sPattern' ) && defined ( 'SPHINX_SEARCH' ) ) {
                                        ?>
                                        <option value="<?php echo osc_esc_html ( osc_update_search_url ( array ( 'sOrder' => '' , 'iOrderType' => '' ) ) ); ?>" <?php if ( Params::getParam ( 'sOrder' ) == '' ) {
                                            echo 'selected';
                                        } ?> ><?php _e ( 'Normal' , 'shopclass' ); ?></option>
                                        <option value="<?php echo osc_esc_html ( osc_update_search_url ( array ( 'sOrder' => 'relevance' , 'iOrderType' => 'desc' ) ) ); ?>" <?php if ( Params::getParam ( 'sOrder' ) == 'relevance' ) {
                                            echo 'selected';
