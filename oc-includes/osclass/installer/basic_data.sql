...
INSERT INTO /*TABLE_PREFIX*/t_preference VALUES
    ...
    ,('osclass', 'rewrite_billing_wallet', 'user/credits', 'STRING')
    ,('osclass', 'rewrite_billing_buy', 'user/credits/buy', 'STRING')
    ,('osclass', 'rewrite_billing_orders', 'user/orders', 'STRING')
    ...
    ,('osclass', 'enable_send_friend', '0', 'BOOLEAN')
    ,('osclass', 'reg_user_can_send_friend', '1', 'BOOLEAN')
    ,('osclass', 'alerts_require_login', '0', 'BOOLEAN')
    ...
    ,('osclass', 'sitemap_number', '5000', 'INTEGER')
    ,('osclass', 'sitemap_categories', '1', 'BOOLEAN')
    ,('osclass', 'sitemap_pages', '1', 'BOOLEAN')
    ,('osclass', 'sitemap_cities', '0', 'BOOLEAN')
    ,('osclass', 'sitemap_regions', '0', 'BOOLEAN')
    ,('osclass', 'sitemap_countries', '0', 'BOOLEAN')
    ,('osclass', 'sitemap_cat_regions', '0', 'BOOLEAN')
    ,('osclass', 'sitemap_cat_city', '0', 'BOOLEAN')
    ,('osclass', 'custom_urls', '', 'STRING')
    ...
    ,('osclass', 'billing_bump_enabled', '0', 'BOOLEAN')
    ,('osclass', 'billing_bump_credits', '0', 'INTEGER')
    ,('osclass', 'billing_bump_cooldown_hours', '24', 'INTEGER')
    ,('osclass', 'billing_highlight_enabled', '0', 'BOOLEAN')
    ,('osclass', 'billing_highlight_credits', '0', 'INTEGER')
