...
/**
 * Core's fallback buy page -- rendered only when the active theme has neither
 * user-billing-buy.php nor user-custom.php of its own. Wraps buy-content.php
 * (the markup) in a self-contained page. See CWebBilling::doView().
 */
...
require __DIR__ . '/buy-content.php';
