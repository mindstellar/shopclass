...
/**
 * Core's fallback wallet page -- rendered only when the active theme has
 * neither user-billing-wallet.php nor user-custom.php of its own. Wraps
 * wallet-content.php (the markup) in a self-contained page. See
 * CWebBilling::doView().
 */
...
require __DIR__ . '/wallet-content.php';
