    ...
    <div class="row">
        <section class="col-md-12">
            <?php if ( osc_count_categories() > 0 ) { ?>
                <h2 class="title text-center"><i
                            class="fa fa-certificate"></i><?php _e( 'Categories' , 'shopclass' ); ?></h2>
                        ...
                        <div class="panel col-md-3">
                            <div class="panel-heading cardbox-default">
                                <h4 class="panel-title">
                                    ...
                                    <span data-maincatid="<?php echo osc_category_id(); ?>"
                                          class="subcat-modal cursor-pointer badge pull-right"><i
