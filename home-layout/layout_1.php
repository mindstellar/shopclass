			...
			<div class="panel panel-default cardbox-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						...
						<a data-toggle="collapse" data-parent="#accordian-cat" href="#cat-<?php echo osc_category_id();?>" class="badge badge-primary pull-right"><i class="fa fa-plus"></i></a>
					</h4>
				</div>
                <div id="cat-<?php echo osc_category_id(); ?>" class="panel-collapse collapse content-listmenu">
                    <ul class="nav">
