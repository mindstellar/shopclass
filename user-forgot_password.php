<?php osc_current_web_theme_path('head.php') ; ?>
    ...
    <?php osc_current_web_theme_path('header.php') ; ?>
        <div class="col-md-12"><div class="container panel panel-body panel-success">
                    ...
                    <form class="tfc-form" action="<?php echo osc_base_url(true) ; ?>" method="post" >
                        ...
                        <fieldset>
                            <p>
                                ...
                                <input type="password" name="new_password" value="" placeholder="<?php echo osc_esc_html(__('Enter Your Password','shopclass')); ?>" />
                            </p>
                            <p>
                                <label for="new_email"><?php _e('Repeat new pasword', 'shopclass') ; ?></label><br />
                                <input type="password" name="new_password2" value="" placeholder="<?php echo osc_esc_html(__('Retype Your Password','shopclass')); ?>" />
                            </p>
